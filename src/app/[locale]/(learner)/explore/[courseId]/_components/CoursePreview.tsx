...
type TFn = ReturnType<typeof useLearnerExploreT>;
...
export default function CoursePreview({ course, modules }: CoursePreviewProps) {
  ...
  }, [course.id, course.enrolled, modules]);
  ...
  const learnHref = `/learn/${slug}?mode=${isCompleted ? 'replay' : 'resume'}`;
  const previewHref = `/learn/${slug}?mode=replay`;
      ...
      <div className="flex-1 px-4 py-6 sm:px-6 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-[1fr_360px] lg:items-start">
          ...
          <div className="min-w-0 space-y-6">
            ...
            <InstructorSection course={course} instructor={instructor} t={t} />
