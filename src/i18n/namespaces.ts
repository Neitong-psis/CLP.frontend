...
export const NS = {
  ...
  educator: {
    ...
    studentsModal: 'educator.studentsPage.modal',
    analytics: 'educator.analyticsPage',
    analyticsCompletion: 'educator.analyticsPage.completion',
    analyticsMetrics: 'educator.analyticsPage.metrics',
    analyticsPerformance: 'educator.analyticsPage.performance',
