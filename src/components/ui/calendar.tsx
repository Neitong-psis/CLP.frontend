...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'group/calendar bg-background p-4 [--cell-radius:var(--radius-md)] [--cell-size:calc(var(--spacing)*8)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent',
