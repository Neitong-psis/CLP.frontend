          ...
          {PROGRAMS.map((program) => (
            ...
            >
              ...
              <div className="relative flex items-center justify-between">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#00003e] text-[#f4a300] transition-colors duration-300 group-hover:bg-[#f4a300] group-hover:text-[#00003e]">
