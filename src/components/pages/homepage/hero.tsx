    ...
    <section className="relative overflow-hidden bg-white">
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:py-28 lg:px-8">
        ...
        <div className="flex flex-col gap-6">
          <div className="inline-flex w-fit items-center gap-2 rounded-full border border-[#f4a300]/30 bg-[#f4a300]/10 px-3 py-1.5 text-xs font-semibold uppercase tracking-widest text-[#f4a300]">
            <span className="h-1.5 w-1.5 rounded-full bg-[#f4a300]" />
            Australia-Accredited · Phnom Penh
          </div>

          <h1 className="text-4xl font-bold leading-tight tracking-tight text-[#00003e] sm:text-5xl lg:text-6xl">
            Shaping tomorrow&apos;s{" "}
          ...
          <div className="mt-4 flex items-center gap-3 text-xs text-[#00003e]/50">
            <div className="flex items-center gap-0.5">
              {[...Array(5)].map((_, i) => (
                <Star key={i} className="h-3.5 w-3.5 fill-[#f4a300] text-[#f4a300]" />
              ))}
            </div>
        ...
        <div className="relative">
          <div className="relative mx-auto aspect-square w-full max-w-md">
            ...
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-[#00003e] to-[#00003e]/80 p-8 shadow-2xl">
              <div className="flex h-full flex-col justify-between text-white">
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest text-[#f4a300]">
                    Student Story
                  </span>
                </div>
                <div>
                  ...
                  <p className="mt-4 text-sm text-white/50">— Sokha, Class of 2025</p>
                </div>
              </div>
            </div>

            {/* Floating badge top-right */}
            <div className="absolute -right-4 -top-4 rotate-3 rounded-2xl bg-[#f4a300] px-4 py-3 shadow-xl">
              <p className="text-[10px] font-bold uppercase tracking-widest text-[#00003e]">
                Now Enrolling
              </p>
            ...
            <div className="absolute -bottom-4 -left-4 -rotate-3 rounded-2xl border border-[#00003e]/10 bg-white px-4 py-3 shadow-xl">
              <p className="text-[10px] font-bold uppercase tracking-widest text-[#e00025]">
                Accredited
              </p>
              <p className="text-sm font-bold text-[#00003e]">Australian Standard</p>
            </div>
          </div>
        </div>
      </div>
