  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <label className="flex cursor-pointer items-center gap-2.5 text-sm text-slate-600 2xl:text-base 3xl:text-lg">
          <input
            type="checkbox"
        ...
        <Link
          ...
          className="text-sm font-semibold text-[#f4a300] transition-opacity hover:opacity-75 2xl:text-base 3xl:text-lg"
        >
          Forgot password?
        </Link>
      </div>
