...
export default function LeftPanel() {
  return (
    <div className="3xl:w-[38%] 3xl:p-28 relative hidden flex-col items-center justify-center overflow-hidden bg-[#00003e] p-10 lg:flex lg:w-[44%] lg:flex-none xl:w-[42%] xl:p-14 2xl:w-[40%] 2xl:p-20">
      {/* Ambient glows */}
      <div
        aria-hidden
        className="3xl:h-[900px] 3xl:w-[900px] pointer-events-none absolute -top-40 -left-40 h-[500px] w-[500px] rounded-full bg-[#f4a300]/10 blur-3xl 2xl:h-[700px] 2xl:w-[700px]"
      />
      <div
        aria-hidden
        className="3xl:h-[800px] 3xl:w-[800px] pointer-events-none absolute -right-20 -bottom-40 h-[400px] w-[400px] rounded-full bg-[#f4a300]/5 blur-3xl 2xl:h-[600px] 2xl:w-[600px]"
      />
