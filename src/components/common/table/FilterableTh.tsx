...
/**
 * A `<th>` whose entire label is the filter toggle: hovering reveals a faint
 * `Filter` icon, and clicking anywhere on the header — text or icon — opens
 * a dropdown of this column's values directly underneath. Once a specific
 * value is selected the icon stays fully visible and colored — same
 * active-state language as `SortableTh`'s arrow, so both affordances read as
